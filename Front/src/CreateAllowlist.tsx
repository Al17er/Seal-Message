      ...
      const cardItems: CardItem[] = await Promise.all(
          caps.map(async (cap) => {
            ...
            return {
              ...
              list: Array.isArray(fields.list) ? fields.list : [],
              name: typeof fields.name === 'string' ? fields.name : 'Unnamed Room',
            };
          })
      );
                      ...
                      <Flex justify="between" align="center" wrap="wrap" gap="3">
                        <div>
                          ...
                          <Text size="2" color="gray">
                            ID: <RadixLink href={getObjectExplorerLink(item.allowlist_id)} target="_blank" rel="noopener noreferrer">
